...
if [ "$SERVER" == "REED" ]; then
    mailx -s "[$SERVER] ClinVar unmatchable conditions" cpark@mcw.edu mtutaj@mcw.edu < $APPDIR/data/unmatchable_conditions.txt
    mailx -s "[$SERVER] ClinVar unmatchable related conditions" cpark@mcw.edu mtutaj@mcw.edu < $APPDIR/data/unmatchable_related_conditions.txt
